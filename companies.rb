...
<body>
    <div id="header_wrap" class="outer">
        <header class="inner">
          ...
          <h2 id="project_tagline">A very basic table of all companies with contributors to Drupal 8 Core
          <p>This is copy of <a href="http://ericduran.github.io/drupalcores/companies.html">http://ericduran.github.io/drupalcores</a>. It's done due that on original resource some data is out of date, especially companies list.</p>
          </h2>
        </header>
    </div>
